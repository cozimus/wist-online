    ...
    <div className="Infopage popup">
      <div className="popup-inner">
        <div className="infopage-container">
          ...
          <h3>Chiamata</h3>
          <p>
            All'interno di ogni round vengono distribuite tutte le carte del
            mazzo (il numero totale di carte varia in base al numero di
            giocatori). A questo punto ogni giocatore a turno, partendo da chi è
            stato scelto come primo e procedendo in senso orario, dovrà fare una
          ...
          <p>
            Una volta che tutti i giocatori hanno chiamato si procede a giocare
            il round. Il giocatore che ha chiamato per primo dovrà giocare una
            carta, e tutti gli altri giocatori dovranno giocare una carta dello
            stesso seme, se ne hanno, altrimenti sono liberi di giocare
            qualsiasi carta. Alla fine del giro si valuta chi ha preso la mano:
            <ul>
              <li>
                se sono state giocare briscole (ad esempio carte di cuori nel
                primo round) ha preso chi ha giocato la carta più alta di
                briscola;
              </li>
              <li>
                se non sono state giocare briscole ha preso chi ha giocato la
                carta più alta dello stesso seme della prima carta.
              </li>
            </ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    dichiarato, allora i suoi punti saranno pari al numero
                    stesso di prese;
                  </li>
                </ul>
              </li>
          ...
          <p>
            Il quinto round si chiama "Libera", e come si evince dal nome
            l'unica regola è che non ci sono briscole, quindi comanda sempre il
            primo seme che viene giocato. Questa regola sarà sempre presente
            negli ultimi 4 round
          </p>
          <p>
          ...
          <p>
            Il settimo round si chiama "Buio", e in questo round si è obbligati
            a chiamare prima di vedere le carte, al buio quindi.
          </p>
          <p>
          ...
          <p>
            ...
            tutte le 48 carte dal 3 all'asso, ma vengono distribuite solo 8
            carte a testa, lasciando le restanti 32 carte inutilizzate. Una
            volta finito il round le carte utilizzate verranno mescolate
            nuovamente all'interno del mazzo e ne verranno discribuite altre 16
            (8 a testa) per iniziare un nuovo round.
          </p>
          <h3>Numero di giocatori</h3>
          <p>
            Ci sono diverse regole che cambiano in base al numero di giocatori;
            in questa sezione faremo un riassunto di tutte queste variabili:
          </p>
